...
The [AI ROI Calculator](/playbook/roi) and [Build vs. Buy Decision Matrix](/playbook/assessment) exist to pressure-test these projections before committing to production investment.
...
The [30-60-90 Training Plan](/playbook/change-management) structures this progression from awareness through fluency. The [Resistance Response Playbook](/playbook/change-management) provides decision trees for the specific objections that surface during adoption.
...
- **Methodology:** [Change Management Phase](/playbook/change-management) — The adoption scaffolding referenced above
