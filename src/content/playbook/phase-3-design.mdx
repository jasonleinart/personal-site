...
tools:
  ...
  - name: "TCO Checklist"
    ...
    type: checklist
  - name: "BATNA and Walk-Away Gate"
    description: "Build the client's best alternative into something executable, then derive the number below which no deal is worth doing. The scorecards rank options; this decides whether to act at all."
    type: framework
relatedAnalysis:
  - "jpmorgan-ai-empire"
  - "legal-ai-roadmap"
