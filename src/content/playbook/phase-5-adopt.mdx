...
tools:
  ...
  - name: "Psychological Safety Assessment"
    ...
    type: checklist
  - name: "Leader Behavior Audit"
    description: "Score the nine leader behaviours that produce psychological safety from three vantage points: leader self, team anonymous, and your own observation. The gap between them is the finding."
    type: framework
  - name: "Framing the Work Script"
    description: "Sponsor script for the initiative announcement. Name the uncertainty, name who depends on whom, and define the real failure as the undisclosed problem rather than the problem."
    type: template
  - name: "Fear/Resistance Diagnostic"
    description: "Surface the concerns people do not raise in public meetings. Interview guide plus anonymous survey, with what to listen for."
    type: framework
relatedAnalysis:
