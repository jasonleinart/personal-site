...
tools:
  ...
  - name: "BATNA and Walk-Away Gate"
    description: "Turn the current-state cost into the price of waiting, then into a reservation value. Borrowed from Phase 3, where it gates the build-vs-buy and vendor decisions."
    type: framework
relatedAnalysis:
  - "jpmorgan-ai-empire"
