...
tools:
  ...
  - name: "Framing the Work Script"
    description: "Sponsor script for the initiative announcement. Framing is a speech act at the start; by rollout the team has already decided whether reporting a problem is safe."
    type: template
relatedAnalysis:
  - "jpmorgan-ai-empire"
